...
class OrganisationCreationHandler:
    """
    ...
    def __init__(self):
        ...
        self.fields_to_translate = ['description']
        self.translation_tool = TranslationTool()

    def process_organisation_creation(self, json_data):
        ...
        try:
            ...
            # translate description of organisation
